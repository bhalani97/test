    ...
    <>
      <Column className="bg-white_A700 font-lato mx-[auto] w-[100%]">
        <Column className="items-start justify-start w-[100%]">
              ...
              <Stack className="lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] w-[100%]">
                <Stack className="absolute lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] inset-[0] w-[100%]">
                  <Row className="absolute bg-gray_100 items-start justify-start top-[0] w-[100%]">
                    <Image
                      src={"images/img_envelopeopent_6.svg"}
                    ...
                    <Image
                      src={"images/img_mobilealt_6.svg"}
                  ...
                  <Stack className="absolute bottom-[0] xl:h-[109px] 2xl:h-[122px] 3xl:h-[146px] h-[162px] lg:h-[95px] left-[0] w-[23%]">
                    <Image
                      src={"images/img_rectangle49_6.svg"}
          ...
          <Text className="font-bold lg:mt-[116px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] mt-[200px] lg:mx-[277px] xl:mx-[316px] 2xl:mx-[356px] 3xl:mx-[427px] mx-[475px] lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-gray_600 text-left w-[auto]">{`Project Details`}</Text>
          <Column className="items-center mt-[1px] w-[100%]">
            <Row className="items-start justify-center w-[100%]">
              <Column className="items-start justify-start lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[22px] mt-[25px] w-[24%]">
                <Text className="font-bold leading-lh14000 text-black_900 lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-left w-[100%]">{`One of your best product become more stand out`}</Text>
                <Text className="font-normal leading-lh17000 mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-gray_600 text-left w-[94%]">{`Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt.`}</Text>
              </Column>
              <Column className="bg-white_A700 items-center justify-start lg:mb-[47px] xl:mb-[54px] 2xl:mb-[60px] 3xl:mb-[72px] mb-[81px] lg:ml-[49px] xl:ml-[56px] 2xl:ml-[63px] 3xl:ml-[76px] ml-[85px] shadow-bs1 w-[19%]">
                <Row className="items-center justify-between lg:mt-[12px] xl:mt-[14px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[21px] w-[100%]">
                  <Text className="font-normal lg:ml-[16px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] ml-[29px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_600 text-left w-[auto]">{`Client`}</Text>
                  <Text className="font-normal lg:mr-[21px] xl:mr-[24px] 2xl:mr-[27px] 3xl:mr-[33px] mr-[37px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-indigo_900 text-right w-[auto]">{`Paula Ramsey`}</Text>
                </Row>
                <Line className="bg-gray_200 h-[1px] 3xl:ml-[22px] ml-[25px] 3xl:mr-[21px] mr-[24px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:mx-[14px] xl:mx-[16px] 2xl:mx-[18px] w-[87%]" />
                <Row className="items-center justify-between lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[20px] w-[100%]">
                  <Text className="font-normal lg:ml-[16px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] ml-[29px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_600 text-left w-[auto]">{`Categories`}</Text>
                  <Text className="font-normal lg:mr-[21px] xl:mr-[24px] 2xl:mr-[27px] 3xl:mr-[33px] mr-[37px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-indigo_900 text-right w-[auto]">{`Interior`}</Text>
                </Row>
                <Line className="bg-gray_200 h-[1px] 3xl:ml-[22px] ml-[25px] 3xl:mr-[21px] mr-[24px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:mx-[14px] xl:mx-[16px] 2xl:mx-[18px] w-[87%]" />
                <Row className="items-center justify-start lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[20px] w-[100%]">
                  <Text className="font-normal lg:ml-[16px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] ml-[29px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_600 text-left w-[auto]">{`Date`}</Text>
                  <Text className="font-normal ml-[109px] lg:ml-[63px] xl:ml-[72px] 2xl:ml-[81px] 3xl:ml-[98px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-indigo_900 text-right w-[auto]">{`23 September 2020`}</Text>
                </Row>
                <Line className="bg-gray_200 h-[1px] 3xl:ml-[22px] ml-[25px] 3xl:mr-[21px] mr-[24px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:mx-[14px] xl:mx-[16px] 2xl:mx-[18px] w-[87%]" />
                <Row className="items-center justify-start lg:my-[12px] xl:my-[14px] 2xl:my-[15px] 3xl:my-[18px] my-[21px] w-[100%]">
                  <Text className="font-normal lg:ml-[16px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] ml-[29px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_600 text-left w-[auto]">{`Tags`}</Text>
                  <Text className="font-normal lg:ml-[37px] xl:ml-[42px] 2xl:ml-[48px] 3xl:ml-[57px] ml-[64px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-indigo_900 text-right w-[auto]">{`branding, vintage, creative`}</Text>
                </Row>
              </Column>
            </Row>
            <Text className="font-normal leading-lh17000 lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-gray_600 text-left w-[48%]">{`Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Volup Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt. tate exercitation incididunt aliquip deserunt. Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt. Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor.`}</Text>
            ...
            <div className="bg-gray_300 lg:h-[443px] xl:h-[507px] 2xl:h-[570px] 3xl:h-[684px] h-[759px] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] mx-[auto] w-[61%]"></div>
            <Row className="items-center justify-center lg:mt-[17px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] mt-[30px] w-[100%]">
              <div className="bg-gray_300 lg:h-[257px] xl:h-[294px] 2xl:h-[331px] 3xl:h-[397px] h-[440px] w-[30%]"></div>
              <div className="bg-gray_300 lg:h-[257px] xl:h-[294px] 2xl:h-[331px] 3xl:h-[397px] h-[440px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] w-[30%]"></div>
            </Row>
            <Text className="font-normal leading-lh17000 mt-[102px] lg:mt-[59px] xl:mt-[68px] 2xl:mt-[76px] 3xl:mt-[91px] mx-[auto] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-gray_600 text-left w-[51%]">{`Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Volup Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt. tate exercitation incididunt aliquip deserunt. Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Volup Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt. tate exercitation incididunt aliquip deserunt.`}</Text>
                  ...
                  <Column className="items-start justify-start lg:mb-[54px] xl:mb-[62px] 2xl:mb-[70px] 3xl:mb-[84px] mb-[94px] w-[9%]">
                    ...
                    <Column className="mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[20px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] mt-[35px] w-[87%]">
                      <Row className="items-center justify-start w-[100%]">
                        <Image
                          src={"images/img_chevronright_3.svg"}
                      ...
                      <Row className="items-center justify-start lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] mt-[5px] w-[100%]">
                        <Image
                          src={"images/img_chevronright_4.svg"}
                          className="xl:h-[11px] 2xl:h-[12px] 3xl:h-[14px] h-[15px] lg:h-[9px] my-[11px] lg:my-[6px] xl:my-[7px] 2xl:my-[8px] 3xl:my-[9px] object-contain w-[6%]"
                          alt="chevronright"
                        />
                        ...
                        <Column className="absolute bottom-[26%] left-[10%] right-[auto] top-[15%] w-[61%]">
                          <Column className="w-[100%]">
                            <Row className="items-start justify-between w-[100%]">
                              <Image
                                src={"images/img_locationfilled_2.svg"}
