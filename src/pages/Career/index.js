...
const CareerPage = () => {
  return (
    <>
      <Column className="bg-white_A700 font-lato items-center justify-start mx-[auto] w-[100%]">
          ...
          <Stack className="lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] w-[100%]">
            <Stack className="absolute lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] inset-[0] w-[100%]">
              <Row className="absolute bg-gray_100 items-start justify-start top-[0] w-[100%]">
                <Image
                  src={"images/img_envelopeopent_10.svg"}
                ...
                <Image
                  src={"images/img_mobilealt_10.svg"}
              ...
              <Stack className="absolute bottom-[0] xl:h-[109px] 2xl:h-[122px] 3xl:h-[146px] h-[162px] lg:h-[95px] left-[0] w-[23%]">
                <Image
                  src={"images/img_rectangle49_10.svg"}
        ...
        <Text className="font-bold lg:mt-[116px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] mt-[200px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-indigo_900 w-[auto]">{`Career`}</Text>
        ...
        <List
          className="gap-[0] min-h-[auto] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] mx-[auto] w-[61%]"
          orientation="vertical"
        >
          <Row className="bg-white_A700 items-center justify-between lg:my-[11px] xl:my-[13px] 2xl:my-[15px] 3xl:my-[18px] my-[20px] shadow-bs1 w-[100%]">
            <Column className="items-start lg:mb-[24px] xl:mb-[28px] 2xl:mb-[31px] 3xl:mb-[37px] mb-[42px] lg:ml-[35px] xl:ml-[40px] 2xl:ml-[45px] 3xl:ml-[54px] ml-[60px] lg:mt-[22px] xl:mt-[26px] 2xl:mt-[29px] 3xl:mt-[35px] mt-[39px] w-[41%]">
              <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-indigo_900 text-left w-[auto]">{`Profesional`}</Text>
              <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] 3xl:mt-[10px] mt-[12px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[90%]">
                <Row className="items-start justify-start w-[59%]">
                  <Image
                    ...
                    alt="Location"
                  />
                  <Text className="font-normal 2xl:ml-[10px] 3xl:ml-[12px] ml-[14px] lg:ml-[8px] xl:ml-[9px] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-indigo_900 text-left w-[auto]">{`Yogyakarta, Indonesia`}</Text>
                </Row>
                <Row className="items-start justify-start lg:ml-[29px] xl:ml-[33px] 2xl:ml-[37px] 3xl:ml-[45px] ml-[50px] w-[29%]">
                  <Image
                    src={"images/img_redeye.svg"}
                    className="lg:h-[21px] xl:h-[24px] 2xl:h-[27px] 3xl:h-[32px] h-[35px] mb-[1px] object-contain lg:w-[20px] xl:w-[23px] 2xl:w-[26px] 3xl:w-[31px] w-[35px]"
                    alt="RedEye"
                  />
                  <Text className="font-normal 2xl:ml-[10px] 3xl:ml-[12px] ml-[14px] lg:ml-[8px] xl:ml-[9px] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-indigo_900 text-left w-[auto]">{`Fulltime`}</Text>
                </Row>
              </Row>
              <Text className="font-normal leading-lh17000 3xl:mt-[10px] mt-[12px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-indigo_900 text-left w-[100%]">{`Amet minim mollit non deserunt ullamco est sit aliqua minim mollit.`}</Text>
            </Column>
            <Button className="bg-deep_orange_500 font-bold lg:mr-[35px] xl:mr-[40px] 2xl:mr-[45px] 3xl:mr-[54px] mr-[60px] lg:my-[49px] xl:my-[56px] 2xl:my-[63px] 3xl:my-[76px] my-[85px] xl:pb-[19px] 2xl:pb-[21px] 3xl:pb-[25px] pb-[28.6px] xl:pt-[18px] 2xl:pt-[20px] 3xl:pt-[24px] pt-[27.6px] lg:py-[16px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-white_A700 w-[20%]">{`Lorem`}</Button>
          </Row>
          <Row className="bg-white_A700 items-center justify-between lg:my-[11px] xl:my-[13px] 2xl:my-[15px] 3xl:my-[18px] my-[20px] shadow-bs1 w-[100%]">
            <Column className="items-start lg:mb-[24px] xl:mb-[28px] 2xl:mb-[31px] 3xl:mb-[37px] mb-[42px] lg:ml-[35px] xl:ml-[40px] 2xl:ml-[45px] 3xl:ml-[54px] ml-[60px] lg:mt-[22px] xl:mt-[26px] 2xl:mt-[29px] 3xl:mt-[35px] mt-[39px] w-[41%]">
              <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-indigo_900 text-left w-[auto]">{`Profesional`}</Text>
        ...
        <Image
          src={"images/img_group112.svg"}
          className="lg:h-[200px] xl:h-[229px] 2xl:h-[257px] 3xl:h-[308px] h-[342px] lg:mt-[116px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] mt-[200px] object-contain w-[100%]"
          alt="Group112"
        />
          ...
          <Column className="bg-bluegray_900 items-center justify-end shadow-bs1 w-[100%]">
            ...
            <Stack className="lg:h-[55px] xl:h-[63px] 2xl:h-[71px] 3xl:h-[85px] h-[94px] 2xl:mt-[100px] 3xl:mt-[120px] mt-[134px] lg:mt-[78px] xl:mt-[89px] mx-[auto] w-[61%]">
              ...
              <Row className="absolute bottom-[31%] inset-x-[0] items-center justify-evenly top-[30%] w-[100%]">
                ...
                <Image
                  src={"images/img_frame116_10.svg"}
