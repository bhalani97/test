      ...
      <Column className="bg-white_A700 font-lato mx-[auto] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
            ...
            <Stack className="lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] w-[100%]">
              <Stack className="absolute lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] inset-[0] w-[100%]">
                <Row className="absolute bg-gray_100 items-start justify-start top-[0] w-[100%]">
                  <Image
                    src={"images/img_envelopeopent.svg"}
                ...
                <Stack className="absolute bottom-[0] xl:h-[109px] 2xl:h-[122px] 3xl:h-[146px] h-[162px] lg:h-[95px] left-[0] w-[23%]">
                  <Image
                    src={"images/img_rectangle49.svg"}
          ...
          <Stack className="bg-gray_300 h-[1027px] lg:h-[600px] xl:h-[686px] 2xl:h-[771px] 3xl:h-[925px] w-[100%]">
            <Stack className="absolute h-[1027px] lg:h-[600px] xl:h-[686px] 2xl:h-[771px] 3xl:h-[925px] right-[0] w-[75%]">
              <Image
                src={"images/img_rectangle68.svg"}
                className="absolute h-[1027px] lg:h-[600px] xl:h-[686px] 2xl:h-[771px] 3xl:h-[925px] inset-y-[0] left-[4%] object-contain right-[0] w-[96%]"
                alt="Rectangle68"
              />
              <Column className="absolute bg-white_A700 items-center justify-start left-[0] shadow-bs top-[0] w-[22%]">
                <Column className="items-start justify-start lg:mt-[15px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] mt-[26px] lg:mx-[29px] xl:mx-[34px] 2xl:mx-[38px] 3xl:mx-[45px] mx-[51px] w-[67%]">
                  <Column className="w-[100%]">
                    <Column className="items-start justify-start w-[100%]">
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_900 text-left w-[auto]">{`About Us`}</Text>
                      <Column className="2xl:mt-[10px] 3xl:mt-[12px] mt-[14px] lg:mt-[8px] xl:mt-[9px] w-[100%]">
                        <Line className="bg-gray_301 h-[1px] w-[100%]" />
                      </Column>
                    </Column>
                    <Column className="items-start justify-start 3xl:mt-[11px] mt-[13px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[100%]">
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-indigo_900 text-left w-[auto]">{`Our Teams`}</Text>
                      <Column className="mt-[11px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[100%]">
                        <Line className="bg-gray_301 h-[1px] w-[100%]" />
                      </Column>
                    </Column>
                  </Column>
                  <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] 3xl:mt-[11px] mt-[13px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] not-italic lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_900 text-left w-[auto]">{`Pricing Plans`}</Text>
                </Column>
                <div className="bg-deep_orange_500 lg:h-[5px] xl:h-[6px] 2xl:h-[7px] h-[8px] lg:mt-[15px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] mt-[26px] w-[100%]"></div>
              </Column>
            </Stack>
            <Column className="absolute items-start justify-start right-[20%] top-[22%] w-[28%]">
          ...
          >
            ...
            <Column className="bg-white_A700 items-center justify-end shadow-bs1 w-[100%]">
              <Column className="items-start justify-start xl:ml-[34px] 3xl:ml-[46px] ml-[52px] xl:mr-[35px] 3xl:mr-[47px] mr-[52.5px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:mx-[30px] 2xl:mx-[39px] w-[72%]">
                <Image
                  src={"images/img_bordernone_1.svg"}
                  className="lg:h-[41px] xl:h-[47px] 2xl:h-[53px] 3xl:h-[64px] h-[70px] ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] object-contain lg:w-[40px] xl:w-[46px] 2xl:w-[52px] 3xl:w-[63px] w-[70px]"
                  alt="bordernone"
                />
                <Column className="lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] mt-[36px] w-[100%]">
            ...
            <Column className="bg-white_A700 items-center justify-end shadow-bs1 w-[100%]">
              <Column className="items-start justify-start xl:ml-[34px] 3xl:ml-[46px] ml-[52px] xl:mr-[35px] 3xl:mr-[47px] mr-[52.5px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:mx-[30px] 2xl:mx-[39px] w-[72%]">
                <Image
                  src={"images/img_bordernone_2.svg"}
                  className="lg:h-[41px] xl:h-[47px] 2xl:h-[53px] 3xl:h-[64px] h-[70px] ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] object-contain lg:w-[40px] xl:w-[46px] 2xl:w-[52px] 3xl:w-[63px] w-[70px]"
                  alt="bordernone"
                />
                <Column className="lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] mt-[36px] w-[100%]">
          ...
          <Stack className="h-[1054px] lg:h-[615px] xl:h-[704px] 2xl:h-[792px] 3xl:h-[950px] lg:mt-[106px] xl:mt-[121px] 2xl:mt-[136px] 3xl:mt-[163px] mt-[182px] w-[100%]">
            <Stack className="absolute h-[1054px] lg:h-[615px] xl:h-[704px] 2xl:h-[792px] 3xl:h-[950px] inset-[0] w-[100%]">
              <div className="absolute bg-gray_300 bottom-[0] lg:h-[563px] xl:h-[644px] 2xl:h-[724px] 3xl:h-[869px] h-[964px] w-[100%]"></div>
              <Image
                src={"images/img_rectangle67.svg"}
                className="absolute h-[1054px] lg:h-[615px] xl:h-[704px] 2xl:h-[792px] 3xl:h-[950px] left-[0] object-contain w-[69%]"
                alt="Rectangle67"
              />
            </Stack>
            <Column className="absolute bottom-[13%] items-start justify-start left-[20%] right-[auto] top-[20%] w-[30%]">
              <Text className="font-extrabold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-left text-white_A700 uppercase w-[auto]">{`service`}</Text>
              <Text className="font-extrabold leading-lh14000 mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-left text-white_A700 uppercase w-[90%]">{`Laboris commodo consequat`}</Text>
              <Column className="lg:mt-[35px] xl:mt-[40px] 2xl:mt-[45px] 3xl:mt-[54px] mt-[60px] w-[100%]">
                <List
                  className="gap-[0] min-h-[auto] w-[100%]"
                  orientation="vertical"
                >
                  <Row className="items-start justify-between xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] w-[100%]">
                    <Stack className="3xl:h-[116px] h-[128px] lg:h-[75px] xl:h-[86px] 2xl:h-[97px] rounded-radius30 shadow-bs1 3xl:w-[115px] w-[128px] lg:w-[74px] xl:w-[85px] 2xl:w-[96px]">
                      <Image
                        src={"images/img_001invert.svg"}
                        className="absolute bottom-[25%] lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] inset-x-[27%] object-contain top-[28%] lg:w-[35px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px] w-[60px]"
                        alt="001invert"
                      />
                    </Stack>
                    <Column className="items-start justify-start lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] mb-[8px] w-[72%]">
                      <Text className="font-extrabold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-left text-white_A700 uppercase w-[auto]">{`Expert Service`}</Text>
                      <Text className="font-normal leading-lh17000 3xl:mt-[10px] mt-[12px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-left text-white_A700 w-[100%]">{`Amet minim mollit non deserunt ullamco est sit aliqua minim mollit non.`}</Text>
                    </Column>
                  </Row>
                  <Row className="items-start justify-between xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] w-[100%]">
                    <Stack className="3xl:h-[116px] h-[128px] lg:h-[75px] xl:h-[86px] 2xl:h-[97px] rounded-radius30 shadow-bs1 3xl:w-[115px] w-[128px] lg:w-[74px] xl:w-[85px] 2xl:w-[96px]">
                      <Image
                        src={"images/img_001invert_1.svg"}
                        className="absolute bottom-[25%] lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] inset-x-[27%] object-contain top-[28%] lg:w-[35px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px] w-[60px]"
                        alt="001invert"
                      />
                    </Stack>
              ...
              <Button className="bg-deep_orange_500 font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] xl:pb-[19px] 2xl:pb-[21px] 3xl:pb-[25px] pb-[28.6px] xl:pt-[18px] 2xl:pt-[20px] 3xl:pt-[24px] pt-[27.6px] lg:py-[16px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-white_A700 w-[41%]">{`Lorem`}</Button>
            </Column>
          </Stack>
        </Column>
        <Stack className="lg:h-[200px] xl:h-[229px] 2xl:h-[257px] 3xl:h-[308px] h-[342px] w-[100%]">
          <Image
            src={"images/img_group111.svg"}
            className="absolute lg:h-[200px] xl:h-[229px] 2xl:h-[257px] 3xl:h-[308px] h-[342px] inset-[0] object-cover w-[100%]"
            alt="Group111"
          />
          <Image
            src={"images/img_group132.svg"}
            className="absolute lg:h-[108px] xl:h-[124px] 2xl:h-[139px] 3xl:h-[167px] h-[184.58px] inset-[0] justify-center m-[auto] object-contain w-[85%]"
            alt="Group132"
          />
        </Stack>
        <Column className="items-start justify-start lg:mt-[116px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] mt-[200px] w-[100%]">
          <Text className="font-extrabold lg:mx-[42px] xl:mx-[48px] 2xl:mx-[54px] 3xl:mx-[65px] mx-[73px] lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-indigo_900 text-left uppercase w-[auto]">{`Blog`}</Text>
          <Text className="font-extrabold leading-lh14000 lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:mx-[42px] xl:mx-[48px] 2xl:mx-[54px] 3xl:mx-[65px] mx-[73px] lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-indigo_900 text-left uppercase w-[27%]">{`Laboris commodo consequat`}</Text>
          <Column className="items-center mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] w-[100%]">
            <List
              className="lg:gap-[15px] xl:gap-[17px] 2xl:gap-[19px] 3xl:gap-[23px] gap-[26.21997px] grid grid-cols-3 min-h-[auto] lg:ml-[33px] xl:ml-[38px] 2xl:ml-[42px] 3xl:ml-[51px] ml-[57px] lg:mr-[31px] xl:mr-[36px] 2xl:mr-[40px] 3xl:mr-[48px] mr-[54px] w-[94%]"
              orientation="horizontal"
            >
              <Column className="shadow-bs1 w-[100%]">
                <div className="bg-gray_300 lg:h-[207px] xl:h-[237px] 2xl:h-[267px] 3xl:h-[320px] h-[354.63px] w-[100%]"></div>
                <Column className="bg-white_A700 items-start justify-center xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15.37px] lg:mt-[8px] w-[100%]">
                  ...
                  <Column className="items-end lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[32px] mb-[36px] lg:mt-[5px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] mt-[9px] w-[100%]">
                    <Column className="items-start justify-start ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] w-[90%]">
                      ...
                      <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] w-[45%]">
                  ...
                  <Column className="items-end lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[32px] mb-[36px] lg:mt-[5px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] mt-[9px] w-[100%]">
                    <Column className="items-start justify-start ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] w-[90%]">
                      ...
                      <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] w-[45%]">
                        <Row className="items-start justify-between w-[33%]">
                          <Image
                            src={"images/img_commentdots_1.svg"}
                            className="lg:h-[21px] xl:h-[24px] 2xl:h-[27px] 3xl:h-[32px] h-[35px] mb-[1px] object-contain lg:w-[20px] xl:w-[23px] 2xl:w-[26px] 3xl:w-[31px] w-[35px]"
                            alt="commentdots"
                          />
                          <Text className="font-normal not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-indigo_900 text-left w-[auto]">{`25`}</Text>
                  ...
                  <Column className="items-end lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[32px] mb-[36px] lg:mt-[5px] 2xl:mt-[6px] xl:mt-[6px] 3xl:mt-[8px] mt-[9px] w-[100%]">
                    <Column className="items-start justify-start ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] w-[90%]">
                      ...
                      <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] w-[45%]">
                        <Row className="items-start justify-between w-[33%]">
                          <Image
                            src={"images/img_commentdots_2.svg"}
                            className="lg:h-[21px] xl:h-[24px] 2xl:h-[27px] 3xl:h-[32px] h-[35px] mb-[1px] object-contain lg:w-[20px] xl:w-[23px] 2xl:w-[26px] 3xl:w-[31px] w-[35px]"
                            alt="commentdots"
                          />
                          <Text className="font-normal not-italic lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-indigo_900 text-left w-[auto]">{`25`}</Text>
            ...
            <Text className="font-extrabold lg:mt-[174px] xl:mt-[199px] 2xl:mt-[224px] 3xl:mt-[269px] mt-[299px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-indigo_900 uppercase w-[auto]">{`Project`}</Text>
            ...
            <Stack className="lg:h-[285px] xl:h-[326px] 2xl:h-[367px] 3xl:h-[440px] h-[488px] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] mx-[auto] w-[61%]">
              <Image
                src={"images/img_maskgroup.svg"}
                className="absolute lg:h-[285px] xl:h-[326px] 2xl:h-[367px] 3xl:h-[440px] h-[488px] inset-[0] object-contain w-[100%]"
                alt="MaskGroup"
              />
              <Row className="absolute bg-deep_orange_500 inset-[0] items-start justify-start w-[100%]">
                <div className="bg-gray_300 lg:h-[149px] xl:h-[171px] 2xl:h-[192px] 3xl:h-[230px] h-[255px] 3xl:mb-[104px] mb-[116px] lg:mb-[67px] xl:mb-[77px] ml-[100px] lg:ml-[58px] xl:ml-[66px] 2xl:ml-[75px] 3xl:ml-[90px] 3xl:mt-[105px] mt-[117px] lg:mt-[68px] xl:mt-[78px] 2xl:my-[87px] lg:w-[148px] xl:w-[170px] 2xl:w-[191px] 3xl:w-[229px] w-[255px]"></div>
                <Column className="items-start justify-start xl:mb-[106px] 2xl:mb-[119px] 3xl:mb-[143px] mb-[159px] lg:mb-[92px] lg:ml-[22px] xl:ml-[26px] 2xl:ml-[29px] 3xl:ml-[35px] ml-[39px] 3xl:mt-[105px] mt-[117px] lg:mt-[68px] xl:mt-[78px] 2xl:mt-[87px] w-[46%]">
                ...
                <Image
                  ...
                  className="xl:h-[11px] 2xl:h-[12px] 3xl:h-[14px] h-[15px] lg:h-[9px] mb-[109px] lg:mb-[63px] xl:mb-[72px] 2xl:mb-[81px] 3xl:mb-[98px] lg:ml-[5px] 2xl:ml-[6px] xl:ml-[6px] 3xl:ml-[8px] ml-[9px] lg:mt-[212px] xl:mt-[242px] 2xl:mt-[273px] 3xl:mt-[327px] mt-[364px] object-contain w-[11%]"
                  alt="Group24"
                />
              </Row>
            </Stack>
            <Stack className="lg:h-[472px] xl:h-[540px] 2xl:h-[608px] 3xl:h-[729px] h-[809px] lg:mt-[193px] xl:mt-[220px] 2xl:mt-[248px] 3xl:mt-[298px] mt-[331px] w-[100%]">
              <Image
                src={"images/img_group96.svg"}
                className="absolute lg:h-[472px] xl:h-[540px] 2xl:h-[608px] 3xl:h-[729px] h-[809px] inset-[0] object-cover w-[100%]"
                alt="Group96"
              />
              <footer className="absolute bottom-[0] inset-x-[0] mx-[auto] w-[61%]">
                <Column className="w-[100%]">
                  <Row className="items-start justify-evenly w-[100%]">
                    <Column className="items-start justify-start lg:mb-[53px] xl:mb-[60px] 2xl:mb-[68px] 3xl:mb-[81px] mb-[91px] w-[23%]">
                    ...
                    <Column className="items-start justify-start lg:mb-[54px] xl:mb-[62px] 2xl:mb-[70px] 3xl:mb-[84px] mb-[94px] w-[15%]">
                    ...
                    <Column className="items-start justify-start xl:mb-[112px] 2xl:mb-[126px] 3xl:mb-[152px] mb-[168.92px] lg:mb-[98px] w-[23%]">
                  ...
                  <Stack className="lg:h-[55px] xl:h-[63px] 2xl:h-[71px] 3xl:h-[85px] h-[94px] 2xl:mt-[100px] 3xl:mt-[120px] mt-[134px] lg:mt-[78px] xl:mt-[89px] w-[100%]">
                    <Input
