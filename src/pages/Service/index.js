    ...
    <>
      <Column className="bg-white_A700 font-lato mx-[auto] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
            ...
            <Stack className="lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] w-[100%]">
              <Stack className="absolute lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] inset-[0] w-[100%]">
                <Row className="absolute bg-gray_100 items-start justify-start top-[0] w-[100%]">
                  <Image
                    src={"images/img_envelopeopent_3.svg"}
                  ...
                  <Image
                    src={"images/img_mobilealt_3.svg"}
                ...
                <Stack className="absolute bottom-[0] xl:h-[109px] 2xl:h-[122px] 3xl:h-[146px] h-[162px] lg:h-[95px] left-[0] w-[23%]">
                  <Image
                    src={"images/img_rectangle49_3.svg"}
          ...
          >
            <Column className="bg-white_A700 items-center justify-end shadow-bs1 w-[100%]">
              <Column className="items-start justify-start xl:ml-[34px] 3xl:ml-[46px] ml-[52px] xl:mr-[35px] 3xl:mr-[47px] mr-[52.5px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:mx-[30px] 2xl:mx-[39px] w-[72%]">
                <Image
                  src={"images/img_bordernone_6.svg"}
            ...
            <Column className="bg-white_A700 items-center justify-end shadow-bs1 w-[100%]">
              <Column className="items-start justify-start xl:ml-[34px] 3xl:ml-[46px] ml-[52px] xl:mr-[35px] 3xl:mr-[47px] mr-[52.5px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:mx-[30px] 2xl:mx-[39px] w-[72%]">
                <Image
                  src={"images/img_bordernone_7.svg"}
                  className="lg:h-[41px] xl:h-[47px] 2xl:h-[53px] 3xl:h-[64px] h-[70px] ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] object-contain lg:w-[40px] xl:w-[46px] 2xl:w-[52px] 3xl:w-[63px] w-[70px]"
                  alt="bordernone"
                />
                <Column className="lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] mt-[36px] w-[100%]">
            ...
            <Column className="bg-white_A700 items-center justify-end shadow-bs1 w-[100%]">
              <Column className="items-start justify-start xl:ml-[34px] 3xl:ml-[46px] ml-[52px] xl:mr-[35px] 3xl:mr-[47px] mr-[52.5px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:mx-[30px] 2xl:mx-[39px] w-[72%]">
                <Image
                  src={"images/img_bordernone_8.svg"}
                  className="lg:h-[41px] xl:h-[47px] 2xl:h-[53px] 3xl:h-[64px] h-[70px] ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] object-contain lg:w-[40px] xl:w-[46px] 2xl:w-[52px] 3xl:w-[63px] w-[70px]"
                  alt="bordernone"
                />
                <Column className="lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] mt-[36px] w-[100%]">
          ...
          <Stack className="bg-bluegray_900 3xl:h-[1109px] h-[1231px] lg:h-[719px] xl:h-[822px] 2xl:h-[924px] lg:mt-[137px] xl:mt-[157px] 2xl:mt-[177px] 3xl:mt-[212px] mt-[236px] w-[100%]">
            <Image
              src={"images/img_maskgroup_1.svg"}
              className="absolute 3xl:h-[1109px] h-[1231px] lg:h-[719px] xl:h-[822px] 2xl:h-[924px] inset-[0] object-cover w-[100%]"
              alt="MaskGroup"
            />
            <Column className="absolute inset-x-[0] items-center justify-start mx-[auto] top-[7%] w-[61%]">
              <Text className="font-extrabold mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Price`}</Text>
              ...
              <Text className="font-normal leading-lh17000 lg:ml-[112px] xl:ml-[128px] 2xl:ml-[144px] 3xl:ml-[172px] ml-[192px] lg:mr-[111px] xl:mr-[127px] 2xl:mr-[143px] 3xl:mr-[171px] mr-[191px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[67%]">{`Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt.`}</Text>
              <List
                className="lg:gap-[17px] xl:gap-[20px] 2xl:gap-[22px] 3xl:gap-[27px] gap-[30px] grid grid-cols-3 min-h-[auto] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] w-[100%]"
                orientation="horizontal"
              >
                <Column className="bg-indigo_900 items-center justify-center shadow-bs2 w-[100%]">
                ...
                <Column className="bg-deep_orange_500 items-center justify-end shadow-bs2 w-[100%]">
                  <Text className="font-extrabold lg:mt-[36px] xl:mt-[41px] 2xl:mt-[46px] 3xl:mt-[55px] mt-[62px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Pro Plan`}</Text>
                  <Text className="font-normal leading-lh17000 lg:mt-[15px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] mt-[26px] mx-[auto] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[69%]">{`Amet minim mollit non deserunt ullamco.`}</Text>
                  <Row className="items-start justify-center lg:mt-[26px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[41px] mt-[46px] w-[100%]">
                    <Text className="font-bold lg:mb-[28px] xl:mb-[32px] 2xl:mb-[36px] 3xl:mb-[44px] mb-[49px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 w-[auto]">{`$`}</Text>
          ...
          <Column className="items-center justify-start lg:mt-[116px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] mt-[200px] w-[100%]">
            <Text className="font-extrabold mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-indigo_900 uppercase w-[auto]">{`Project`}</Text>
