...
const PricingPage = () => {
  return (
    <>
      <Column className="bg-bluegray_900 font-lato mx-[auto] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
            ...
            <Stack className="lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] w-[100%]">
              <Stack className="absolute lg:h-[124px] xl:h-[141px] 2xl:h-[159px] 3xl:h-[191px] h-[211px] inset-[0] w-[100%]">
                <Row className="absolute bg-gray_100 items-start justify-start top-[0] w-[100%]">
                  <Image
                    src={"images/img_envelopeopent_7.svg"}
                  ...
                  <Image
                    src={"images/img_mobilealt_7.svg"}
                ...
                <Stack className="absolute bottom-[0] xl:h-[109px] 2xl:h-[122px] 3xl:h-[146px] h-[162px] lg:h-[95px] left-[0] w-[23%]">
                  <Image
                    src={"images/img_rectangle49_7.svg"}
          ...
          <Text className="font-extrabold lg:mt-[116px] xl:mt-[133px] 2xl:mt-[150px] 3xl:mt-[180px] mt-[200px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Price`}</Text>
          ...
          <Text className="font-normal leading-lh17000 xl:ml-[378px] 2xl:ml-[425px] 3xl:ml-[510px] ml-[567px] xl:mr-[377px] 2xl:mr-[424px] 3xl:mr-[509px] mr-[566px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] lg:mx-[330px] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[41%]">{`Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt.`}</Text>
          <Stack className="lg:h-[1386px] xl:h-[1586px] 2xl:h-[1784px] 3xl:h-[2140px] h-[2376px] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] w-[100%]">
            <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] h-[1371px] lg:h-[800px] xl:h-[915px] top-[0] w-[100%]">
              <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] h-[1371px] lg:h-[800px] xl:h-[915px] inset-[0] w-[100%]">
                <Image
                  src={"images/img_maskgroup_3.svg"}
                  className="absolute bottom-[0] 3xl:h-[1109px] h-[1231px] lg:h-[719px] xl:h-[822px] 2xl:h-[924px] object-cover w-[100%]"
                  alt="MaskGroup"
                />
                <Column className="absolute bg-indigo_900 items-center justify-center left-[20%] shadow-bs2 top-[0] w-[19%]">
                  <Text className="font-extrabold lg:mt-[36px] xl:mt-[41px] 2xl:mt-[46px] 3xl:mt-[55px] mt-[62px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Pro Plan`}</Text>
                  <Text className="font-normal leading-lh17000 lg:mt-[15px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] mt-[26px] mx-[auto] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[69%]">{`Amet minim mollit non deserunt ullamco.`}</Text>
                  <Row className="items-start justify-center lg:mt-[26px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[41px] mt-[46px] w-[100%]">
                    <Text className="font-bold lg:mb-[28px] xl:mb-[32px] 2xl:mb-[36px] 3xl:mb-[44px] mb-[49px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 w-[auto]">{`$`}</Text>
                    <Text className="font-extrabold 2xl:ml-[10px] 3xl:ml-[12px] ml-[14px] lg:ml-[8px] xl:ml-[9px] text-center lg:text-fs42 xl:text-fs48 2xl:text-fs54 3xl:text-fs64 text-fs72 text-white_A700 w-[auto]">{`24`}</Text>
                  </Row>
                  <Button className="bg-deep_orange_500 font-bold lg:mb-[35px] xl:mb-[40px] 2xl:mb-[45px] 3xl:mb-[54px] mb-[60px] lg:mt-[26px] xl:mt-[30px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[45px] mx-[auto] xl:pb-[19px] 2xl:pb-[21px] 3xl:pb-[25px] pb-[28.6px] xl:pt-[18px] 2xl:pt-[20px] 3xl:pt-[24px] pt-[27.6px] lg:py-[16px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-white_A700 w-[63%]">{`Lorem`}</Button>
                </Column>
              </Stack>
              <Column className="absolute bg-deep_orange_500 inset-x-[0] items-center justify-start mx-[auto] shadow-bs2 top-[0] w-[19%]">
                <Text className="font-extrabold lg:mt-[36px] xl:mt-[41px] 2xl:mt-[46px] 3xl:mt-[55px] mt-[62px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Pro Plan`}</Text>
                <Text className="font-normal leading-lh17000 lg:mt-[15px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] mt-[26px] mx-[auto] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[69%]">{`Amet minim mollit non deserunt ullamco.`}</Text>
                <Row className="items-start justify-center lg:mt-[26px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[41px] mt-[46px] w-[100%]">
                  <Text className="font-bold lg:mb-[28px] xl:mb-[32px] 2xl:mb-[36px] 3xl:mb-[44px] mb-[49px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 w-[auto]">{`$`}</Text>
                ...
                <Button className="bg-white_A700 font-bold lg:mt-[26px] xl:mt-[30px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[45px] mx-[auto] xl:pb-[19px] 2xl:pb-[21px] 3xl:pb-[25px] pb-[28.6px] xl:pt-[18px] 2xl:pt-[20px] 3xl:pt-[24px] pt-[27.6px] lg:py-[16px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-indigo_900 w-[63%]">{`Lorem`}</Button>
                <div className="bg-white_A700 lg:h-[5px] xl:h-[6px] 2xl:h-[7px] h-[8px] lg:mt-[30px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] mt-[52px] w-[100%]"></div>
              </Column>
            </Stack>
            <Column className="absolute bg-indigo_900 items-center justify-center right-[20%] shadow-bs2 top-[0] w-[19%]">
              <Text className="font-extrabold lg:mt-[36px] xl:mt-[41px] 2xl:mt-[46px] 3xl:mt-[55px] mt-[62px] mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Pro Plan`}</Text>
              <Text className="font-normal leading-lh17000 lg:mt-[15px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] mt-[26px] mx-[auto] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[69%]">{`Amet minim mollit non deserunt ullamco.`}</Text>
              <Row className="items-start justify-center lg:mt-[26px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[41px] mt-[46px] w-[100%]">
                <Text className="font-bold lg:mb-[28px] xl:mb-[32px] 2xl:mb-[36px] 3xl:mb-[44px] mb-[49px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 w-[auto]">{`$`}</Text>
            ...
            <Column className="absolute bottom-[0] inset-x-[0] items-center justify-start mx-[auto] w-[61%]">
              <Text className="font-extrabold mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Project`}</Text>
              <Text className="font-extrabold lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] mx-[auto] text-center lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-white_A700 uppercase w-[auto]">{`Laborum magna nulla duis`}</Text>
              <Text className="font-normal leading-lh17000 lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] not-italic text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 text-white_A700 w-[67%]">{`Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt.`}</Text>
              <List
                className="lg:gap-[57px] xl:gap-[66px] 2xl:gap-[74px] 3xl:gap-[89px] gap-[99px] grid grid-cols-3 min-h-[auto] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] w-[100%]"
              ...
              >
                <Stack className="lg:h-[189px] xl:h-[217px] 2xl:h-[244px] 3xl:h-[292px] h-[324px] w-[100%]">
                  <Row className="absolute h-[max-content] inset-y-[0] items-start justify-center my-[auto] right-[22%] w-[41%]">
                    <Text className="font-extrabold lg:text-fs42 xl:text-fs48 2xl:text-fs54 3xl:text-fs64 text-fs72 text-right text-white_A700 w-[auto]">{`75`}</Text>
                    <Text className="font-bold lg:mb-[29px] xl:mb-[34px] 2xl:mb-[38px] 3xl:mb-[45px] mb-[51px] xl:ml-[10px] 2xl:ml-[11px] 3xl:ml-[13px] ml-[15px] lg:ml-[8px] lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-left text-white_A700 w-[auto]">{`%`}</Text>
                  </Row>
                  <CircularProgressbar
                    ...
                    strokeWidth={1}
                    styles={{
                      trail: { strokeWidth: 1, stroke: "#f5f5f53f" },
                      path: {
                ...
                <Stack className="lg:h-[189px] xl:h-[217px] 2xl:h-[244px] 3xl:h-[292px] h-[324px] w-[100%]">
                  <Row className="absolute h-[max-content] inset-y-[0] items-start justify-center my-[auto] right-[22%] w-[41%]">
                    <Text className="font-extrabold lg:text-fs42 xl:text-fs48 2xl:text-fs54 3xl:text-fs64 text-fs72 text-right text-white_A700 w-[auto]">{`90`}</Text>
                    <Text className="font-bold lg:mb-[29px] xl:mb-[34px] 2xl:mb-[38px] 3xl:mb-[45px] mb-[51px] xl:ml-[10px] 2xl:ml-[11px] 3xl:ml-[13px] ml-[15px] lg:ml-[8px] lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-left text-white_A700 w-[auto]">{`%`}</Text>
                  </Row>
                  <CircularProgressbar
                    className="absolute lg:h-[189px] xl:h-[217px] 2xl:h-[244px] 3xl:h-[292px] h-[324px] inset-[0] overflow-visible rounded-radius50 shadow-bs1 w-[100%]"
                ...
                <Stack className="lg:h-[189px] xl:h-[217px] 2xl:h-[244px] 3xl:h-[292px] h-[324px] w-[100%]">
                  <Row className="absolute h-[max-content] inset-y-[0] items-start justify-center my-[auto] right-[22%] w-[41%]">
                    <Text className="font-extrabold lg:text-fs42 xl:text-fs48 2xl:text-fs54 3xl:text-fs64 text-fs72 text-right text-white_A700 w-[auto]">{`65`}</Text>
                    <Text className="font-bold lg:mb-[29px] xl:mb-[34px] 2xl:mb-[38px] 3xl:mb-[45px] mb-[51px] xl:ml-[10px] 2xl:ml-[11px] 3xl:ml-[13px] ml-[15px] lg:ml-[8px] lg:text-fs24 xl:text-fs28 2xl:text-fs31 3xl:text-fs37 text-fs42 text-left text-white_A700 w-[auto]">{`%`}</Text>
                  </Row>
                  <CircularProgressbar
                    className="absolute lg:h-[189px] xl:h-[217px] 2xl:h-[244px] 3xl:h-[292px] h-[324px] inset-[0] overflow-visible rounded-radius50 shadow-bs1 w-[100%]"
              ...
              <Row className="items-center justify-between lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] w-[100%]">
                <Column className="items-center w-[28%]">
                  <Text className="font-extrabold mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Laborum magna`}</Text>
                  <Text className="font-bold 3xl:mt-[10px] mt-[12px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-white_A700 w-[auto]">{`Magna nulla`}</Text>
                </Column>
                <Column className="items-center w-[28%]">
                  <Text className="font-extrabold mx-[auto] text-center lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-white_A700 uppercase w-[auto]">{`Laborum magna`}</Text>
                  <Text className="font-bold 3xl:mt-[10px] mt-[12px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-white_A700 w-[auto]">{`Magna nulla`}</Text>
              ...
              <Stack className="bg-deep_orange_500 lg:h-[285px] xl:h-[326px] 2xl:h-[367px] 3xl:h-[440px] h-[488px] mt-[100px] lg:mt-[58px] xl:mt-[66px] 2xl:mt-[75px] 3xl:mt-[90px] w-[100%]">
                <Image
                ...
                <Column className="items-start justify-start lg:mb-[54px] xl:mb-[62px] 2xl:mb-[70px] 3xl:mb-[84px] mb-[94px] w-[9%]">
                  ...
                  <Column className="mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[20px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] mt-[35px] w-[87%]">
                    <Row className="items-center justify-start w-[100%]">
                      <Image
                        src={"images/img_chevronright_5.svg"}
                    ...
                    <Row className="items-center justify-start lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] mt-[5px] w-[100%]">
                      <Image
                        src={"images/img_chevronright_6.svg"}
